...
import { emailPattern, namePattern, phoneNumberPattern, minBirthDate } from 'app/layout/entities/globalConstants';
import { WebCamDialogComponent } from 'app/layout/dialogs/webcam/webcamdialog.component';
import { MatDialog } from '@angular/material/dialog';
import { Location } from '@angular/common';

@Component({
    selector: 'cg-admin-profile',
...
export class AdminProfileComponent implements OnInit {
 ...
 openWebCam() {
  const dialogRef = this.dialog.open(WebCamDialogComponent, {
    ...
    data: { },
    autoFocus: true,       //  ensure focus moves into dialog
    restoreFocus: true     //  return focus to trigger after close
  });
